...
format: 
  revealjs:
    multiplex: true
    navigation-mode: linear      # only horizontal navigation keys/swipes
    scroll-view:                 # configure the new Scroll-View feature
      activation-width: 0        # 0 = never auto-enter Scroll View
      snap: mandatory            # (default) snap to whole slides if user toggles it on
